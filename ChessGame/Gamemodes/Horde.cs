...
namespace ChessGame.Gamemodes
{
    public class Horde : Gamemode
    {
        ...
        public override Chessboard GenerateBoard()
        {
            ...
            board[new Coordinate(1, 4)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(2, 4)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(5, 4)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(6, 4)] = new Pawn { Color = TeamColor.White };

            board[new Coordinate(0, 3)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(1, 3)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(2, 3)] = new Pawn { Color = TeamColor.White };
            ...
            board[new Coordinate(0, 2)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(1, 2)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(2, 2)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(3, 2)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(4, 2)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(5, 2)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(6, 2)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(7, 2)] = new Pawn { Color = TeamColor.White };
            ...
            board[new Coordinate(0, 0)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(1, 0)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(2, 0)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(3, 0)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(4, 0)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(5, 0)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(6, 0)] = new Pawn { Color = TeamColor.White };
            board[new Coordinate(7, 0)] = new Pawn { Color = TeamColor.White };
